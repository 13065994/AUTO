...
module.exports.run = async function({ api, event, args, prefix, admin }) {
		...
		const CREATORLINK = "https://www.facebook.com/gerald max";
		const BOTCREATOR = "Gerald";
		const BOTNAME = "𝐋𝐯𝟐°•➣「𝐠𝐞𝐫𝐚𝐥𝐝✮𝐛𝐨𝐭」";
		const FILESOWNER = "pakwu";
		const juswa = moment.tz("Africa/Lagos").format("『D/MM/YYYY』 【HH:mm:ss】");
